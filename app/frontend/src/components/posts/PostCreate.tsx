...
import { FaEdit, FaImage, FaVideo, FaUserCircle, FaCheckCircle, FaExclamationCircle, FaPoll, FaSmile, FaPaperclip } from 'react-icons/fa';
      ...
      <div className="w-full max-w-2xl p-8 bg-white rounded-2xl shadow-2xl border border-blue-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-6" aria-label="Create post form">
          ...
          <div>
            ...
            <input type="file" accept="image/*,video/mp4" onChange={handleMediaChange} className="block w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 focus:ring-2 focus:ring-blue-200" aria-label="Upload media" />
            {previewUrl && (
